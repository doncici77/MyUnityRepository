...
class Unit
{
    // 클래스에는 해당 클래스로 만들 객체의 정보를 작성함.
    public string unit_name;

    // 클래스에는 해당 클래스로 만들 객체의 동작, 기능을 작성할 수 있음. (메소드)
...
public class ClassSample : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // 클래스변수명.필드를 통해 클래스가 가지고 있는 필드(변수)를 사용할 수 있음.
        ...
        // 인스턴스: 객체를 소프트웨어에서 실체화한 것(new 를 통해 만들어졌으면 인스터스)
