...
public class UnityDelegateSample : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // 대리자의 경우 바로 기능을 구현해서 사용하는 것도 가능함.
        func01 = () => 10;
        func01 = Test;
    ...
    // 하지만 다음 조건을 지킬 경우 같은 이름의 메소드를 사용 할 수 있다.
    ...
    // 인터페이스, abstract class 등에서 선언(정의)만 되어있는 메소드를 전달받는 경우라면
    // 강제적으로 구현해야 합니다.

    // 하위 클래스에서 원하는 기능에 대한 구현
    // 인터페이스, abstraact class 등에서 제공받는 틀에 맞춰 정돈된 코드 설계 가능
    // 하나의 객체로 여려 형태를 표현하는 다형성 구현에도 효과적
